...
const EXAMPLE_DATA: TicketTableItem[] = [
  {status:false, createdBy: 'Hydrogen',description: 'desc1',createdAt:1},
  {status:true, createdBy: 'Helium',description: 'desc2',createdAt:1},
  {status:false, createdBy: 'Lithium',description: 'desc3',createdAt:1},
  {status:true, createdBy: 'Beryllium',description: 'desc4',createdAt:1},
  {status:true, createdBy: 'Boron',description: 'desc5',createdAt:1},
